## A Godot Port of Socket-Singleton https://github.com/emboiko/Socket_Singleton/tree/master
## Put this Node into your Autoloads or somewhere in your Node tree.
